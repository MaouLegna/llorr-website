...
params:
  ind: "MR030"
  patch: "Patch 2.18 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°30)"
  description: "Shroud the meta in wings."
  cardlurl: "https://dd.b.pvp.net/latest/set3/en_us/img/cards/03MT014-full.png"
  prev:  "2021-10-20 21:00:00" #UTC tz / 'current' previous week start
  start: "2021-10-27 21:00:00" #UTC tz / 'current' week start
  end:   "2021-11-03 21:00:00" #UTC tz / 'current' week end
...
Data only with Last-Season Masters
    ...
    text_transform(
      ...
      fn = function(x){
        ...
        glue::glue(
          #595959 #grey35
          #7f7f7f #grey50
          "<div style='line-height:10px'><span style='font-weight:bold;color:#595959;font-variant:small-caps;font-size:14px'>{percent}</div>
           <div style='line-height:12px'><span style='font-weight:bold;color:#595959;font-size:10px'>({frac})</span></div>"
        )
        }
      )
...
MUgrid.gt.final <- MUgrid.gt |>
  ...
  tab_source_note(
    source_note = md(glue::glue("MU from Last-Season and Current Masters.
                                The upper value is from Old Masters as they have many more games while the bottom value is from New Masters as they have many more games.
  ...
  #       #595959 #grey35
  #       #7f7f7f #grey50
  #       "<div style='line-height:9px'><span style='color:black;font-variant:small-caps;font-size:13px'>{x}</div>"
  #     )
  #     }
  #   )
...
It's not a rare/underdog deck, but I'm morally obliged to follow the Grand General and display his potential when recovering the Rune Blade. ( Also Riven's decks are fun too )
...
deck.of.week <- "Riven/Swain (BC/NX)"
