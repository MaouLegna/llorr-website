...
params:
  ind: "MR043"
  patch: "Patch 3.00 - Week 4"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°43)"
  description: "Magic Disadventures Seaonal Tournament Waiting Room"
  cardlurl: "https://dd.b.pvp.net/latest/set5/en_us/img/cards/05BC058-full.png"
  start: "2022-01-26 18:00:00" #UTC tz / 'current' week start
  end:   "2022-02-02 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
...
<!-- Number of Players: **`r nMaster`** Master / **`r nDiamond`** HighDiamond ^[HighDiamond are defined as "players who played against Master player in a Ranked games but **are not** Master themselves"] -->
...
gtsave(nPlayer_tbl, glue::glue("images/{params$ind}-players.png")) |> invisible()
```
...
#     okCI:=(!between(0.50,LCI,UCI)),
#     direction:=ifelse(muWR>0.50,"POS","NEG"),
#     CI = glue("({percent(LCI,accuracy = 0.1)} - {percent(UCI,accuracy = 0.1)})" ) ) -> MUtbl
# 
# tibble::tibble( 
