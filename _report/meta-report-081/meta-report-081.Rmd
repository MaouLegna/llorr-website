...
params:
  ind: "MR081"
  season: "S16"
  patch: "Patch 3.17 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°81)"
  description: "I'm sorry for the person the players have become with Seraqueen being released in Legends of Runeterra."
  cardlurl: "https://dd.b.pvp.net/latest/set6cde/en_us/img/cards/06PZ021-full.png"
  start: "2022-10-19 18:00:00" #UTC tz / 'current' week start
  end:   "2022-10-26 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
