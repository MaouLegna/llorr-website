...
params:
  ind: "MR048"
  patch: "Patch 3.3 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°48)"
  description: "Tri (Beam) Again?"
  cardlurl: "https://dd.b.pvp.net/latest/set5/en_us/img/cards/05PZ006-full.png"
  start: "2022-03-02 18:00:00" #UTC tz / 'current' week start
  end:   "2022-03-09 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
