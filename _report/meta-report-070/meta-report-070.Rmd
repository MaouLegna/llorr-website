...
params:
  ind: "MR070"
  patch: "Patch 3.12 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°70)"
  description: "See no Meta, DeckBuild no Meta, Play no Meta"
  cardlurl: "https://dd.b.pvp.net/latest/set2/en_us/img/cards/02BW034T1-full.png"
  start: "2022-08-03 18:00:00" #UTC tz / 'current' week start
  end:   "2022-08-10 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
