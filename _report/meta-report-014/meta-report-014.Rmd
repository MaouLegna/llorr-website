---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°14)"
description: |
  "First week" of Rise of the Underworld, the calm before the Ruination"
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04BW005T2-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_014",
  htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04BW005T2-full.png")
)
```
</aside>
