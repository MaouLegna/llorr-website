...
params:
  ind: "MR054"
  patch: "Patch 3.5 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°54)"
  description: "1..~2..3.. The complete Dark content for LoR"
  cardlurl: "static.wikia.nocookie.net/leagueoflegends/images/c/c6/05BC058T2_Infernal-full.png"
  start: "2022-04-13 18:00:00" #UTC tz / 'current' week start
  end:   "2022-04-20 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
