---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°22)"
description: |
  Patch 2.14 - Week 2 - Requiem for Akshan/Sivir
base_url: https://llorr-stats.netlify.app
preview: "http://dd.b.pvp.net/2_15_0/set5/en_us/img/cards/05BC041-full.png"
author:
...
params:
  ...
  end:   "2021-09-08 21:00:00" #UTC tz / 'current' week end
...
meta() %>%
  ...
  meta_social(
    ...
    image = "http://dd.b.pvp.net/2_15_0/set5/en_us/img/cards/05BC041-full.png",
    image_alt = "Poppy lv1",
    og_type = "website",
    og_author = "Legna",
...
nGames_tbl <- LoR.Match.RMD %>%
  ...
  tab_header(
    ...
    subtitle = "Patch 2.14 second week / Master players"
...
`r kableExtra::text_spec("Note :", color = "red")` currently all dual region cards have only their main region as possible value assigned. It'll be fixed in time for the next report but currently it makes so that BandleCity playrate is overestimated. The same problem also apply to the card's inclusion rates, with Lulu being the most notable case affected by this.
...
Usually I don't take a meta-deck for this section, but the underdog decks are either "old decks" or with just too few games. So, with EUM getting near I choose something that's quite on the rise in EU: Nami / Zoe, even if it's exactly the server where it seems to perform better (hard to say without a interval estimate)
...
```{r}
# deck.of.week <- "Nami / Zoe"
deck.of.week <- "Lulu / Poppy (BC/DE)"
