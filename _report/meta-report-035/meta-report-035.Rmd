...
#' Read gamesDT
###############
LoR.Match.RMD   <- fread(file.path("C:","LlorR","data","raw","LoR_MatchDT_S10_218_220.csv"), header = T, na.strings = c("", NA))

#' Read Temp
###############
Temp.Match.RMD  <- fread(file.path("C:","LlorR","data","raw","old-data-special","LoR_MatchDT_S10_fromLastSeason.csv"), header = T, na.strings = c("", NA))
...
```{r account-info}
masterEU <- fread(file.path("C:","LlorR","data","raw","master","LoR_Master_S10_EU.csv"),
                              header = T, na.strings = c("", NA), encoding = "UTF-8")

masterNA <- fread(file.path("C:","LlorR","data","raw","master","LoR_Master_S10_NA.csv"),
                              header = T, na.strings = c("", NA), encoding = "UTF-8")

masterASIA <- fread(file.path("C:","LlorR","data","raw","master","LoR_Master_S10_AS.csv"),
                              header = T, na.strings = c("", NA), encoding = "UTF-8")
