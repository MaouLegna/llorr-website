...
params:
  ...
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°67)"
  description: "Let the bonk begin!"
  cardlurl: "eve card"
  start: "2022-07-13 18:00:00" #UTC tz / 'current' week start
  end:   "2022-07-20 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
