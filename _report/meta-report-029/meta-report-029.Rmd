...
params:
  ind: "MR029"
  patch: "Patch 2.18 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°29)"
  description: "Shroud the meta in wings."
  cardlurl: "https://dd.b.pvp.net/latest/set3/en_us/img/cards/03MT014-full.png"
  prev:  "2021-10-13 21:00:00" #UTC tz / 'current' previous week start
  start: "2021-10-20 21:00:00" #UTC tz / 'current' week start
  end:   "2021-10-27 21:00:00" #UTC tz / 'current' week end
...
gtsave(gtWinning, glue::glue("./images/meta-report/{params$ind}-topWin.png")   )
```
