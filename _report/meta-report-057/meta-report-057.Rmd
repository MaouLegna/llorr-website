...
params:
  ind: "MR056"
  patch: "Patch 3.6 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°57)"
  description: "A Curious Journey Seasonal Tournament Waiting Room"
  cardlurl: "https://dd.b.pvp.net/3_6_0/set5/en_us/img/cards/05BC161T1-full.png"
  start: "2022-05-04 18:00:00" #UTC tz / 'current' week start
  end:   "2022-05-11 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
