...
params:
  ind: "MR051"
  patch: "Patch 3.3 - Week 5"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°51)"
  description: "To the Most Fluffable Evil? Mind Swapped Feline (Ex) Rioter"
  cardlurl: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01PZ023-full.png"
  start: "2022-03-23 18:00:00" #UTC tz / 'current' week start
  end:   "2022-03-30 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
...
NA.master.ladder   <- NROW(master.NA)+1 # HKGCrisper07 keeps not remaining
