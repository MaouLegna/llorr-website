...
params:
  ind: "MR072"
  patch: "Patch 3.13 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°72)"
  description: "When in doubt, Pirate-Aggro them!"
  cardlurl: "https://dd.b.pvp.net/latest/set2/en_us/img/cards/02BW060-full.png"
  start: "2022-08-17 18:40:00" #UTC tz / 'current' week start
  end:   "2022-08-24 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
