...
params:
  ind: "MR066"
  patch: "Patch 3.10 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°66)"
  description: "WorldWalker Seaonal Tournament - Open Rournds - Waiting Room"
  cardlurl: "https://dd.b.pvp.net/latest/set6/en_us/img/cards/06NX028-full.png"
  start: "2022-07-06 18:00:00" #UTC tz / 'current' week start
  end:   "2022-07-13 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
