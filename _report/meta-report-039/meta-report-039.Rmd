...
params:
  ...
  description: "Ttwas was the Day of the Balance Patch"
...
ggsave(glue::glue("./images/meta-report/{params$ind}-reg-freq.png"),plot = Reg.plot_freq,width = 12,height = 8)
```
...
ggsave(glue::glue("./images/meta-report/{params$ind}-reg-freq-bycards.png"),plot = Reg.plot_freq,width = 12,height = 8)
```
:::
