...
nGames_tbl <- tbl_merge( 
  ...
  tab_footnote(
    footnote = md(glue::glue(
      ...
      ASIA Master {masterASIA[,.N]}/{masterASIA[!is.na(puuid),.N]}"
      )),
...
# cowplot::save_plot(filename = glue::glue("./images/meta-report/{params$ind}-reg-freq.png"),plot = Reg.plot_freq, base_width = 12, base_height = 8)
```
...
# cowplot::save_plot(filename = glue::glue("./images/meta-report/{params$ind}-reg-freq-bycards.png"),plot = Reg.plot_freq_bycards, base_width = 12, base_height = 8)
```
:::
...
```{r day-by-day-master, fig.width=12, fig.height=8}
m = 12
...
ggsave(glue::glue("./images/meta-report/{params$ind}-playrate-daybyday.png"),plot = meta_evo, width=12, height=8)
```
:::
...
```{r day-by-day-diamond, fig.width=12, fig.height=8}
m = 12
...
ggsave(glue::glue("./images/meta-report/{params$ind}-playrate-daybyday-diamond.png"),plot = meta_evo, width=12, height=8)
```
:::
