...
ggsave(glue::glue("./images/meta-report/{params$ind}-reg-freq.png"),width = 12,height = 8)
```
...
ggsave(glue::glue("./images/meta-report/{params$ind}-reg-freq-bycards.png"),width = 12,height = 8)
```
:::
