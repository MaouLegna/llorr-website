---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°8)"
description: |
  First week of patch 2.8. Testing the win rates in a reference meta
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04NX004T2-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_008",
  htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04NX004T2-full.png")
)
```
</aside>
