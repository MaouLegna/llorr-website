...
params:
  ind: "MR058"
  patch: "Patch 3.7 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°58)"
  description: "A Curious Journey Seasonal Tournament - Playoff - Waiting Room"
  cardlurl: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01DE054-full.png"
  start: "2022-05-11 18:00:00" #UTC tz / 'current' week start
  end:   "2022-05-18 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
...
For the full detailed report go to: [A Curious Journey Open Rounds Report](https://www.llorr-stats.com/report/seasonal-005/)

::: {.l-page}
::::: {.panelset}

::: panel
### Top Deck Decks Performance {.panel-name}

```{r}
knitr::include_graphics("images/S2022-05-14-LMI-table-v2.png")
```
:::
