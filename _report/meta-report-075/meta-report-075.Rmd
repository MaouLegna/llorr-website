...
params:
  ind: "MR075"
  season: "S15"
  patch: "Patch 3.14 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°75)"
  description: "Well, this week could have been akward..."
  cardlurl: "https://dd.b.pvp.net/latest/set6cde/en_us/img/cards/06BC015T2-full.png"
  start: "2022-09-07 18:00:00" #UTC tz / 'current' week start
  end:   "2022-09-14 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
