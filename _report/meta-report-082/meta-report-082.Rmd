...
params:
  ind: "MR082"
  season: "S16"
  patch: "Patch 3.18 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°82)"
  description: "Want to hear something spooky? There was no balance changes for this patch!"
  cardlurl: "https://dd.b.pvp.net/latest/set6cde/en_us/img/cards/06PZ021-full.png"
  start: "2022-10-26 18:00:00" #UTC tz / 'current' week start
  end:   "2022-11-02 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
