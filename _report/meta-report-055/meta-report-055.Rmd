...
params:
  ind: "MR055"
  patch: "Patch 3.5 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°55)"
  description: "So the patch is both worthless and great? Pretty standard"
  cardlurl: "https://dd.b.pvp.net/3_4_0/set5/en_us/img/cards/05SH011-full.png"
  start: "2022-04-20 18:00:00" #UTC tz / 'current' week start
  end:   "2022-04-27 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
