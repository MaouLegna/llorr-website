...
params:
  ind: "MR050"
  patch: "Patch 3.3 - Week 4"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°50)"
  description: "Don't Do That. Don't Give Us Hope (Rubin Zoo)"
  cardlurl: "https://dd.b.pvp.net/latest/set5/en_us/img/cards/05DE009-full.png"
  start: "2022-03-16 18:00:00" #UTC tz / 'current' week start
  end:   "2022-03-23 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
