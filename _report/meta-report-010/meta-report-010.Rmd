---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°10)"
description: |
  First week of patch 2.9 for LoR Not a complete sample of all games played at master since they exceed the API rate limit I could cover at the moment I created this file.
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04FR001T1-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_010",
  htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04FR001T1-full.png")
)
```
</aside>
