...
params:
  ind: "MR069"
  season: "S14"
  patch: "Patch 3.11 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°69)"
  description: "The Nicest of Reports"
  cardlurl: "https://dd.b.pvp.net/latest/set6/en_us/img/cards/06SH009-full.png"
  start: "2022-07-27 18:00:00" #UTC tz / 'current' week start
  end:   "2022-08-03 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
...
nMaster   <- LoR_Account_RMD[!is.na(seasonal), .N]
