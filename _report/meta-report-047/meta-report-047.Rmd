...
params:
  ind: "MR047"
  patch: "Patch 3.2 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°47)"
  description: "The soon to be Path of Champion Meta Report?"
  cardlurl: "https://dd.b.pvp.net/3_2_0/set5/en_us/img/cards/05FR013-full.png"
  start: "2022-02-23 18:00:00" #UTC tz / 'current' week start
  end:   "2022-03-02 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
...
nPlayers <- LoR.Account.RMD |>
  ...
  mutate(rank = factor(rank, levels = c("Master","Diamond"), ordered = T ) ) |>
