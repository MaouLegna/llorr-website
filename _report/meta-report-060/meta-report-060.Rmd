...
params:
  ind: "MR060"
  patch: "Patch 3.8 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°60)"
  description: "Jhin Jhin Jhin Jhin"
  cardlurl: ""
  start: "2022-05-25 18:00:00" #UTC tz / 'current' week start
  end:   "2022-06-01 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
