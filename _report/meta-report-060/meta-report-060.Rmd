...
params:
  ...
  cardlurl: "https://dd.b.pvp.net/3_8_0/set6/en_us/img/cards/06NX012T7-full.png"
...
# LoR_Deck_RMD       <- data.table::fread(file.path("D:", "LoR_DECK.csv"), na.strings = c("", NA), colClasses = "character")
