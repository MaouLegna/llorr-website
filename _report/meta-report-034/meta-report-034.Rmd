...
LoR.Deck.RMD <- LoR.Deck.RMD |>
  mutate( archetype = map_chr(archetype,~str_replace_all(.x,",","/") )  )
```
...
LoR.Melt.Matches.RMD <- Temp.Match.RMD |>
  ...
  mutate( factions = map_chr(.x = factions, ~str_remove_all(.x, paste(c("_Name","faction_", ""), collapse = "|") ) ),
          factions = str_replace_all(factions, set_names(data_regions$abbreviation, data_regions$nameRef)) ) |>
