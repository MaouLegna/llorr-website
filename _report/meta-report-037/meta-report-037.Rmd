...
params:
  ind: "MR037"
  patch: "Patch 2.22 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°37)"
  description: "1/1 Doctor(s).LoR prescribes the current meta"
  cardlurl: "https://dd.b.pvp.net/latest/set5/en_us/img/cards/05IO004-full.png"
  prev:  "2021-11-08 18:00:00" #UTC tz / 'current' previous week start
  start: "2021-12-15 18:00:00" #UTC tz / 'current' week start
  end:   "2021-12-22 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
