...
masterapac <- fread(file.path("C:","LlorR","data","raw","account","LoR_Master_S11_AS.csv"),
                              header = T, na.strings = c("", NA), encoding = "UTF-8") |>
  filter(time <= as.POSIXct(params$end,"UTC"))
...
nGames_tbl <- tbl_merge( 
  ...
  #     apac Master playerDecks in the ladder {masterapac[!is.na(puuid),.N]} while number of possible Master playerDecks recovered is {masterapac[,.N]}"
  #     )),
