...
# EMEA
emea_stats <- compute_seasonal_stats(seasonal = LoR_Melt_Seasonal, ladder = LoR_Melt_Matches_RMD, lineup = LineUp_DT, result = Game_Result, server = "europe",  playoff_riotid = emea_top32)

# NA
na_stats   <- compute_seasonal_stats(seasonal = LoR_Melt_Seasonal, ladder = LoR_Melt_Matches_RMD, lineup = LineUp_DT, result = Game_Result, server = "americas",playoff_riotid = na_top32  )
...
<!-- Region_Freq <- full_join(Region_Freq, Region_Freq_Server, by = "region") |> -->
<!--   mutate( -->
...
seasonal_champion_plot(server = "apac", result = Game_Result, lineup = LineUp_DT)
```
:::
...
seasonal_champion_plot(server = "europe", result = Game_Result, lineup = LineUp_DT)
```
:::
...
seasonal_champion_plot(server = "americas", result = Game_Result, lineup = LineUp_DT)
```
:::
