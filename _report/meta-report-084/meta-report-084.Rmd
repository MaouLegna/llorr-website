...
params:
  ind: "MR084"
  season: "S16"
  patch: "Patch 3.19 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°84)"
  description: "Start of World Tournament 2022 - Battle-fly me to the World"
  cardlurl: "https://dd.b.pvp.net/latest/set6cde/en_us/img/cards/06RU009T6-full.png"
  start: "2022-11-09 18:00:00" #UTC tz / 'current' week start
  end:   "2022-11-16 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
