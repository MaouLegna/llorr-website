...
params:
  ind: "MR040"
  patch: "Patch 3.00 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°40)"
  description: "The meta that fits in the hand"
  cardlurl: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01PZ020-full.png"
  prev:  "2021-11-29 18:00:00" #UTC tz / 'current' previous week start
  start: "2022-01-05 18:00:00" #UTC tz / 'current' week start
  end:   "2022-01-12 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
...
knitr::opts_chunk$set(
  ...
  fig.path   = glue::glue("./images/meta-report/{params$ind}-"),
  layout     = "l-page",
  preview    = FALSE
)
...
gtsave(nGames_tbl,"bytheNumbers.png") |> invisible()
```
# Regions
