---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°4)"
description: |
  Meta Report of a sample of games from LoR Seasonal tournament / Rise of the Ascended.
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SH047T3-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
    href="https://rpubs.com/Legna/MetaReport_004",
    htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SH047T3-full.png")
)
```
</aside>
