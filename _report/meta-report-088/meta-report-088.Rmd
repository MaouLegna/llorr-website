...
params:
  ind: "MR088"
  season: "S17"
  patch: "Patch 3.21 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°88)"
  description: "World was hot but so was the meta -fixed"
  cardlurl: "https://dd.b.pvp.net/latest/set6cde/en_us/img/cards/06RU026-full.png"
  start: "2022-12-07 19:00:00" #UTC tz / 'current' week start
  end:   "2022-12-14 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
