...
description: |
  Patch 2.14 - Week 1 - Start of the BandleCity madness
...
good_color <- make_color_pal(c("white", "white", "steelblue"))
```
...
get_deck_structure(SubDeck_deck_code) %>%
  ...
  reactable(.,
            ...
            columns = list(
              ...
              # .rownames = colDef(name = "n", sortable = TRUE, align = "left")
            )
  )
```
:::
