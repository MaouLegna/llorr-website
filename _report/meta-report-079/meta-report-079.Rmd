...
params:
  ind: "MR079"
  season: "S15"
  patch: "Patch 3.16 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°79)"
  description: "Yasuo won a Seasonal Tournament, what's your excuse now?"
  cardlurl: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01IO015-full.png"
  start: "2022-10-05 18:00:00" #UTC tz / 'current' week start
  end:   "2022-10-12 19:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 25
