...
params:
  ind: "S2022-08-27"
  seasonal_name: "Forces from Beyond"
  title: "THE SEASONAL REPORT IS VAST (n°7)"
  description: "Seasonal Tournament - Forces from Beyond - Open Rounds & Playoff "
  cardlurl: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01DE001-full.png"
  last_season: "S14"
  seasonalDate: "2022-08-27"
...
LineUp_DT <- LoR_Melt_Seasonal |>
  ...
  mutate(id = factor(id,level=c(1,2,3),ordered = T) ) |>
