---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°11)"
description: |
  Second week of Patch 2.9 and time frame Riot may use for balance changes
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SH020T1-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_011",
  htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SH020T1-full.png")
)
```
</aside>
