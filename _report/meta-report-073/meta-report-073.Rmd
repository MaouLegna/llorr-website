...
params:
  ind: "MR073"
  patch: "Patch 3.13 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°73)"
  description: "No more Kai'Sa rule34 meta; now we have pORNN"
  cardlurl: "https://dd.b.pvp.net/latest/set6/en_us/img/cards/06SH009T2-full.png"
  start: "2022-08-24 18:00:00" #UTC tz / 'current' week start
  end:   "2022-08-31 19:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
