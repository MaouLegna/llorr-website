...
params:
  ind: "MR065"
  patch: "Patch 3.10 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°65)"
  description: "It's so hot outside that even Tybaulk is hoping for rain"
  cardlurl: "https://dd.b.pvp.net/latest/set6/en_us/img/cards/06NX028T1-full.png"
  start: "2022-06-29 18:00:00" #UTC tz / 'current' week start
  end:   "2022-07-06 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
