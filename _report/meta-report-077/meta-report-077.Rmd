...
params:
  ind: "MR077"
  season: "S15"
  patch: "Patch 3.15 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°77)"
  description: "Leona-chan: Praise the Sun of Tomorrow! \\[T]/"
  cardlurl: "https://dd.b.pvp.net/latest/set3/en_us/img/cards/03MT054T1-full.png"
  start: "2022-09-21 18:00:00" #UTC tz / 'current' week start
  end:   "2022-09-28 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 25
