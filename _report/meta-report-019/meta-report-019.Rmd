...
Just the OG way I used to display the grid. Aside for the different color palette it doesn't bring more information compared to the other version that actually use more shades and which is also easier to the eyes. I'll probably remove this version the next week.
...
bscols(
  ...
  list(
    ...
    filter_slider("muGames", "#Games", data, ~muGames, width = "100%",step = 100,min = 0),
  ...
  reactable(data,
            ...
            columns = list(
              ...
              CI       = colDef(name = "CI",minWidth = 120)
              ),
