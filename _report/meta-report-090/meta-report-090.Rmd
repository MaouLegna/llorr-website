...
params:
  ind: "MR090"
  season: "S17"
  patch: "Patch 3.21 - Week 3"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°90)"
  description: "Happy 2023"
  cardlurl: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01FR009T1-full.png"
  start: "2022-12-21 18:00:00" #UTC tz / 'current' week start
  end:   "2022-12-28 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
