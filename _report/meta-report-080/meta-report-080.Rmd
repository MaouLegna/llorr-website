...
params:
  ind: "MR080"
  season: "S16"
  patch: "Patch 3.17 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°80)"
  description: "Pointing menacely"
  cardlurl: "https://dd.b.pvp.net/latest/set6cde/en_us/img/cards/06DE021T1-full.png"
  start: "2022-10-12 19:00:00" #UTC tz / 'current' week start
  end:   "2022-10-19 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
