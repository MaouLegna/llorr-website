...
# Melt tbl
LoR.Melt.Temp.RMD <- LoR.Match.DT.RMD |>
...
#   
gt.tbl <- table_bythenumbers(LoR.Match.DT.RMD)
nGames    <- LoR.Melt.Temp.RMD[,.N]
nSeasonal <- LoR.Account.RMD[seasonal=="seasonal",.N]
```

Number of Players: **`r nSeasonal`** Master
...
LoR.Account.RMD |>
  ...
  tbl_summary(label = list(activeShard = "Shard")) |>
  bold_labels() |>
  as_gt() |>
  tab_options(
...
plot_daily(
  ...
  limit = .15,
  end   = as_datetime("2022-02-18 12:00:00")
  ) -> meta_evo
