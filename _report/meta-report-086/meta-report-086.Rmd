...
params:
  ind: "MR086"
  season: "S16"
  patch: "Patch 3.20 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°86)"
  description: "See you stat-wizard and thanks for all the data"
  cardlurl: "https://dd.b.pvp.net/3_14_0/set1/en_us/img/cards/01IO041T1-full.png"
  start: "2022-11-23 18:00:00" #UTC tz / 'current' week start
  end:   "2022-11-30 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 10
