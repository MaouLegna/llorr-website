...
params:
  ind: "MR068"
  patch: "Patch 3.11 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°68)"
  description: ""
  cardlurl: "eve card"
  start: "2022-07-20 18:00:00" #UTC tz / 'current' week start
  end:   "2022-07-27 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
