---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°15)"
description: |
  Second and last week of patch 2.11, right before the Ruination Event
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set1/en_us/img/cards/01IO009T2-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_015",
  htmltools::img(src="https://dd.b.pvp.net/latest/set1/en_us/img/cards/01IO009T2-full.png")
)
```
</aside>
