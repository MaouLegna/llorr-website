...
Number of Players: **`r nMaster`** Master / **`r nDiamond`** HighDiamond

`r kableExtra::text_spec("Note:", color = "red")` Reminding that HighDiamond are defined as "players who played against Master player in a Ranked games but ARE NOT Master themselves"
...
Player to Games Ratio:  **`r round(nGames.Master/nMaster,1)`** at Master / **`r round(nGames.Diamond/nDiamond,1)`** at Diamond
