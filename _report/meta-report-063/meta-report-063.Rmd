...
params:
  ind: "MR063"
  patch: "Patch 3.9 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°63)"
  description: "Dris week you sleep with the fish"
  cardlurl: "https://dd.b.pvp.net/latest/set6/en_us/img/cards/06BW006T3-full.png"
  start: "2022-06-15 18:00:00" #UTC tz / 'current' week start
  end:   "2022-06-22 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 50
