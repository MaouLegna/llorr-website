...
params:
  ind: "MR078"
  season: "S15"
  patch: "Patch 3.16 - Week 1"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°78)"
  description: "The Darkin Saga Awakening Seasonal Tournament - Waiting Room"
  cardlurl: "https://dd.b.pvp.net/latest/set2/en_us/img/cards/02NX007T2-full.png"
  start: "2022-09-28 18:00:00" #UTC tz / 'current' week start
  end:   "2022-10-05 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck_cc:  20
  nDeck_day: 12
  min_games: 25
