---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°9)"
description: |
  Second week of patch 2.8 Added the LMI
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04MT008T1-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_009",
  htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04MT008T1-full.png")
)
```
</aside>
