...
# load Games DT
LoR.Account.RMD <- list.files(path = file.path("C:", "LlorR", "data", "raw"), pattern = glue("^(.*)ACCOUNT_S12(.*)csv$"), full.names = T) |>
...
nGames.Master  <- NROW(LoR.Melt.Master.RMD)
nGames.Diamond <- NROW(LoR.Melt.Diamond.RMD)
...
react.LU.top32 <- top32tbl |>
  ...
  reactablefmtr::add_subtitle(c("Magic Disadventures Playoff - Top32 LineUps"), background_color = "white") |>
...
# reactablefmtr::save_reactable_test(input = react.LU.top32,output = glue::glue("images/{params$ind}-top32-decks.png")) |> invisible()
```
:::
