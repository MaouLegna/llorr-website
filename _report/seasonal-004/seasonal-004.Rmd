...
Game.Result.APAC <- LoR.Melt.Seasonal |>
  ...
  mutate(round = case_when(
    ...
    # JST = UTC - 9hrs
    timeBlock > with_tz(force_tz(timeBlock.1.start,"Japan") + minutes(60),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.1.end,"Japan") + minutes(60),"UTC") ~ 1, # 11:55
    timeBlock > with_tz(force_tz(timeBlock.2.start,"Japan") + minutes(60),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.2.end,"Japan") + minutes(60),"UTC") ~ 2, # 13:00
    timeBlock > with_tz(force_tz(timeBlock.3.start,"Japan") + minutes(60),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.3.end,"Japan") + minutes(60),"UTC") ~ 3, # 14:05
    timeBlock > with_tz(force_tz(timeBlock.4.start,"Japan") + minutes(60),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.4.end,"Japan") + minutes(60),"UTC") ~ 4, # 15:10
    timeBlock > with_tz(force_tz(timeBlock.5.start,"Japan") + minutes(60),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.5.end,"Japan") + minutes(60),"UTC") ~ 5, # 16:15
    
    timeBlock > with_tz(force_tz(timeBlock.6.start,"Japan") + minutes(145),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.6.end,"Japan") + minutes(145),"UTC") ~ 6, # 17:45
    timeBlock > with_tz(force_tz(timeBlock.7.start,"Japan") + minutes(145),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.7.end,"Japan") + minutes(145),"UTC") ~ 7, # 18:50
    timeBlock > with_tz(force_tz(timeBlock.8.start,"Japan") + minutes(145),"UTC") & timeBlock <= with_tz(force_tz(timeBlock.8.end,"Japan") + minutes(145),"UTC") ~ 8, # 19:55
    timeBlock > with_tz(force_tz(timeBlock.9.start,"Japan") + minutes(145),"UTC") ~ 9 # 21:00
    )
  ) |>
  group_by(playerID,opponentID,server,timeBlock ) |>
...
ggsave(glue::glue("images/{params$ind}-RegionPR.png"),plot = Region.Freq.plot, width = 12, height = 8) |> invisible()
```
