...
Number of (Ranked) matches analysed **`r LoR.Melt.Master.RMD[,.N]/2`** or **`r LoR.Melt.Master.RMD[,.N]`** games. / **Master** Players

Number of (Ranked) matches analysed **`r LoR.Melt.Diamond.RMD[,.N]/2`** or **`r LoR.Melt.Diamond.RMD[,.N]`** games. / **~HighDiamond**
