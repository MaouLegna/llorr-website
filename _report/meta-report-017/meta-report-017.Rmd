---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°17)"
description: |
  Second week of patch 2.12 and Ruination Event. With no patch changes being announced the meta is expected to stabilize for the most past around the current values.
base_url: https://llorr-stats.netlify.app
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SI055T2-full.png"
author:
...
params:
  ...
  start: "2021-07-21 21:00:00" #UTC tz / 'current' week start
  end:   "2021-07-28 21:00:00" #UTC tz / 'current' week end
...
meta_evo <- ggplot(
  ...
  scale_x_datetime(
    ...
    limits = c(as.POSIXct(params$start, tz="UTC"), as.POSIXct(params$end, tz="UTC")+hours(6))
...
I wanted to choose a Viego's deck but it was hard to decide which one since there are several different (mainly because of the piared region) so how about more than one deck?
