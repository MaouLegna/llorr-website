...
params:
  ind: "MR049"
  patch: "Patch 3.3 - Week 2"
  title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°49)"
  description: "Long (Broken) turns have we waited, Tri-Beam Activated"
  cardlurl: "https://dd.b.pvp.net/latest/set5/en_us/img/cards/05PZ012-full.png"
  start: "2022-03-09 18:00:00" #UTC tz / 'current' week start
  end:   "2022-03-16 18:00:00" #UTC tz / 'current' week end
  nGrid: 10
  nDeck.CC:  20
  nDeck.Day: 12
  min.games: 5
