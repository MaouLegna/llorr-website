---
title: "THE META REPORT NAME IS TOO LONG, TOO DAMN LONG (n°5)"
description: |
  Meta Report of a sample of games from Legends of Runeterra. Games of the same buff/nerfs Adding DT and ggpattern.
base_url: https://llorr-stats.netlify.app  
preview: "https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SH003T2-full.png"
author:
...
```{r, echo=FALSE}
htmltools::a(
  href="https://rpubs.com/Legna/MetaReport_005",
  htmltools::img(src="https://dd.b.pvp.net/latest/set4/en_us/img/cards/04SH003T2-full.png")
)
```
</aside>
