...
description: |
  On the Resources page it's possible to find link for MatchUps and General winrate/deckcodes/structures that is updated regularly and use the entire patch data. <br>
  New - 2021-09-22: Added a new analysis on the LMI that includes the ban-rate of a deck when using Bo3 data.
output:
