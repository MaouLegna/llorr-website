...
Update: the API is still bugged regarding the leaderboard player. Meaning it's impossible to know who is at Master at the moment.
As I completed most of the changes I wanted to add the updates are back but will have to rely only on the players who attended the last seasonal tournament.

I could easily add more players but that would create messy data and I want my "identity" to be extremely clear in what I provide, and adding "random" players is among the last things I would like to do.

Blame Riot as of now if anything.
