...
Important: With the release of the latest set WorldWalkers there are many changes I have to implement in addition to the ones I was already planning to, while I'm not going to slack off, I need to take my time to do everything well enough so that in the future new radical changes won't be too hard to add and allow to quicker and more stable updates.
Most likely I will need the entire weekend and be fully back online by the end of the month.

Sorry for the inconvenience.

Note: I'm still collecting the data
