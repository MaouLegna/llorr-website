---
title: "Match Ups Data (from Patch 2.14-post patch onward)"
author: "by Legna"
output:
...
params:
  ...
  start: "2021-10-20 21:00:00" #UTC tz / 2.14 <- World Patch to 2.18 ( one week later because of world patch )
  end:   "2022-01-01 21:00:00" #UTC tz / 2.18 <- Balance Patch
...
ft
flextable::save_as_image(x = ft, path = "images/mugrid_temp.png") |> invisible()
```
...
downloadthis::download_file(
  path = file.path("images/mugrid_temp.png"),
