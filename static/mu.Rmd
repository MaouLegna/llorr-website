...
flexdashboard::valueBox(glue::glue("{summary_info$nRankedMaster} Master Ranked Games"), 
                        caption = glue::glue("min {params$min_mu_games} games - {summary_info$nMuMaster} games used"), 
                        icon = "fa-table", 
...
flexdashboard::valueBox(glue::glue("{summary_info$nRankedDiamond} Master Ranked Games"), 
                        caption = glue::glue("min {params$min_mu_games} games - {summary_info$nMuDiamond} games used"), 
                        icon = "fa-table", 
