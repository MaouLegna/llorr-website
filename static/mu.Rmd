...
Previous Seasonal {data-icon="fa-table"}
================================
...
```{r}
flexdashboard::valueBox(glue::glue("{summary_info$total_ranked_master} Seasonal Ranked Games"), 
                        caption = glue::glue("min {params$min_mu_games} games - {summary_info$used_ranked_master} games used - Up until Master are Many"), 
                        icon = "fa-table", 
