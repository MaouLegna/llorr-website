...
LoR.Match.RMD      <- fread(file.path("C:","LlorR","data","raw","LoR_S11DT.csv"), header = T, na.strings = c("", NA))

#' Read Diamond DT
##################
# LoR.Diamond.RMD <- fread(file.path("C:","LlorR","data","raw","LoR_TempDT.csv"), header = T, na.strings = c("",NA))
```
...
<!-- LoR.Melt.Extra.RMD <- LoR.Diamond.RMD |> -->
