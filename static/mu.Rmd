...
gt::gtsave(data = gtMU_grid, glue::glue("images/{params$grid_name}.png"), vwidth = 1500, vheight = 1000) |> invisible()
gt::gtsave(data = gtMU_grid, "images/mugrid.png",     vwidth = 1500, vheight = 1000) |> invisible()
```
...
downloadthis::download_file(
  ...
  button_label = glue("Download MU (World players) data as .csv
                        min 5 games"), 
    output_name = "mutable", 
    button_type = "success", 
    has_icon = TRUE, 
