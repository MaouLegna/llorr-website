...
```{r update-dataset}
update_lor_database(server_abbr = "EU",last_season = "S16",  delete = TRUE, check = TRUE)
update_lor_database(server_abbr = "NA",last_season = "S16",  delete = TRUE, check = TRUE)
update_lor_database(server_abbr = "APAC",last_season = "S16",delete = TRUE, check = TRUE)
```
