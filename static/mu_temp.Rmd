...
```{r load-data}
# load DeckDT
LoR_Deck_RMD       <- data.table::fread(file.path("C:", "LlorR", "data", "raw", "LoR_DECK_S17.csv"), na.strings = c("", NA), colClasses = "character")
...
grid_source_note <- gt::md(
  glue::glue("MatchUp values from Ranked games of the player who were listed in playruneterra.com as sure or potential World attendences
