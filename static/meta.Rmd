...
params:
  ...
  end:     "2022-01-05 18:00:00" #UTC tz /
---
...
tibble(
  ...
  mutate( game_start_time_utc = as.Date(game_start_time_utc) ) -> Champion.deck.daily
...
tibble(
  ...
  left_join(
    ...
    by = c("playerDeck","intDate") ) |>
  mutate( across(where(is.numeric), ~replace_na(.x, 0)) ) |>
  mutate( game_start_time_utc = as.Date(game_start_time_utc) ) -> Champion.deck.daily.diamond
```
