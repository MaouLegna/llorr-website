---
title: "Meta & Decks (Glory in Navori Patch 4.3)"
author: "by Legna"
...
flexdashboard::valueBox(value = summary_info$n_master, 
                        caption = glue::glue("Prev Season Top 1024 Master Players"), 
                        icon = "fa-medal", 
                        color = "#65c0a9")
```
...
<!--                         caption = glue::glue("Number of Ranked Games - by ~Prev Master players"), -->
<!--                         icon = "fa-table", -->
<!--                         color = "#a88b32") -->
<!-- ``` -->
