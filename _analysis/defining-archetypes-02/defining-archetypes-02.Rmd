...
# #' distance matrix
DSim_ex   <- cos.dsimMatrix(LoR.Archetype.Ex$deck_code)
DSim_mini <- cos.dsimMatrix(codes =  LoR.Archetype.Mini$deck_code )
DSim_mini <- dsimMatrix(codes =  LoR.Archetype.Mini$deck_code )
```
...
Since clustering is popular in many fields, there exist a great number of clustering methods. And this is already a problem for the archetype problem
