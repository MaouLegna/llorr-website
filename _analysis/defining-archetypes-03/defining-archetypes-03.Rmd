...
Of the region comparisons all (55) sub-matrix in the diagonal remain necessary (so all NX/PZ vs all NX/PZ), what remains are the cases with only one shared region.
...
In a TL:DR we end up reducing our initial problem with  `r 55*56/2` sub-matrix to one with 45 sub-matrix containing all dual region combinations and 10 sub-matrix which contains all the MonoRegion decks AND all the ~mono region decks.
