...
It's highly possible that Zach uses a more complex methodology compared to the one we will present as they have access to a bigger pool of variables and so being able to control for a bigger number of counfounders. Still, the core concept should still remain similar.
...
$S(d)_{i,j} = f( MU(d)_{i,k} - MU(d)_{j,k} ) \forall k$
