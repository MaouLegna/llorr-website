...
# Skill-Cap - The Vicious (Syndicate) Way
...
Let us take Hearthstone as an example: if we want to say that at top 1000 Legends players are more proficient than Diamond players with a certain deck a common approach would be to compare such deck win rate (WR) across those ranks and assume the difference in win rate can be 



Assessing the differences in ski

Comparing WR across different ranks of players if an easy an intuitive task
