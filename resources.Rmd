...
data_in <- tibble::tribble(
  ...
  "Bo3-Helper", "https://legnavv.shinyapps.io/Bo3-helper/", "Helper for Bo3. Using mostly the most played archetypes (data from 2.14/2.16).",
  "Decks Codes/Structures", glue::glue("{base_url}/static/meta.html"), "Dashboard with Meta or Underdog Decks' Structures and Information of some deckcodes information"
) 
data_in %>%
  reactable::reactable(
    # searchable = TRUE,
