...
data_in <- tibble::tribble(
  ...
  "Decks Codes/Structures", "https://llorr-stats.netlify.app/static/meta.html", "Dashboard with Meta or Underdog Decks' Structures and Information of some deckcodes information"
) 
data_in %>%
  reactable::reactable(
    # searchable = TRUE,
