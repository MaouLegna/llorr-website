...
seqDate <- seq(as.POSIXct(params$start, tz = "UTC"),floor_date(now(),unit = "day")+hours(18) ,"day") # +days(1) since for who knows what reason it doesn't include the current day
```
