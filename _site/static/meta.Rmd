...
Champion.deck.daily |>
  ...
  labs(x = "Date",
       y = "PlayRate",
       title = "Evolution of Play Rate over time - from Seasonal Players"
...
# ggsave("images/meta-evo-temp.png",width = 12,height = 8)
```
...
```{r value-player-base}
flexdashboard::valueBox(glue::glue("{LoR.Account.RMD[seasonal=='seasonal',.N]}"),
