...
```{r}
LoR_Melt_Matches_RMD <- LoR_Melt_Matches_RMD |>
...
WR_tbl_24h <- LoR_Melt_Matches_RMD |>
...
deck_code_tbl_24hrs  <- LoR_Melt_Matches_RMD |>
...
ggsave(filename = "images/meta-evo-temp.png", plot = hourly_meta_plot, width = 12, height = 8) |> invisible()
```
