...
gtsave(data = gtMU_grid, "images/mugrid_308.png", vwidth = 1500, vheight = 1000) |> invisible()
...
gtsave(data = gtMU_grid, "images/mugrid_308_diamond.png", vwidth = 1500, vheight = 1000) |> invisible()
```
