...
output:
  flexdashboard::flex_dashboard:
    navbar:
      - { icon: "fa-trophy", href: "https://www.llorr-stats.com/static/meta.html", align: right }
...
LoR.Melt.Matches.RMD <- LoR.Match.RMD |>
  ...
  # select(-ends_with("puuid"),-contains("puuid"))
...
```{r filters}
crosstalk::filter_select("player", "Player's Deck", data, ~player)
crosstalk::filter_select("opponent", "Opponent's Deck", data, ~opponent)
...
-   **Player's Deck** - deck's archetype of the player

-   **Opponent's Deck** - deck's archetype of the opponent
