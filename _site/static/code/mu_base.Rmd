---
title: "Match Ups Data(from Patch 3.20 a Curious Journey)"
author: "by Legna"
output:
...
params:
  ...
  start:   "2022-02-16 19:00:00" #UTC tz / 2.21 Balance
  end:     "2022-03-16 18:00:00" #UTC tz / 2.21 Balance
  minMUGames: 30 # min number of games for a MU
...
# load Games DT
LoR.Match.DT.RMD <- list.files(path = file.path("C:", "LlorR", "data", "raw"), pattern = glue("^(.*)Temp_DT_S11(.*)csv$"), full.names = T) |>
